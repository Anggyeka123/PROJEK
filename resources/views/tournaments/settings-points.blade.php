...
<head>
    ...
    <title>Standar Liga Poin - {{ $tournament->name }}</title>
            ...
            <header class="border-b border-slate-800 bg-slate-900 bg-opacity-50 backdrop-blur sticky top-0 z-40">
                <div class="px-4 sm:px-6 py-6">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            <p class="text-xs sm:text-sm text-emerald-400 font-semibold mb-2">STANDAR LIGA POIN</p>
                            <h1 class="text-2xl sm:text-3xl font-bold">Atur Skor Klasemen</h1>
                            <p class="text-slate-400 text-sm mt-2">Tetapkan poin untuk menang, imbang, dan kalah sesuai sistem liga.</p>
                        </div>
                    </div>
                </div>
            </header>

            @include('tournaments.partials.points-settings-panel')
        </main>
    </div>
</body>
</html>
