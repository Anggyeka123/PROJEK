            ...
            @forelse($matches as $match)
                <div class="grid grid-cols-[2fr_2fr_1fr_2fr_1fr_1fr_1fr] gap-4 items-center border-b border-slate-800 last:border-b-0 px-4 py-4">
                    ...
                    @php
                        ...
                        $leftDisplay = isset($match['home_team_id']) ? $leftRaw : ($leftIsPlaceholder ? 'Menunggu hasil pertandingan sebelumnya' : $leftRaw);
                    @endphp
                    ...
                    @php
                        ...
                        $rightDisplay = isset($match['away_team_id']) ? $rightRaw : ($rightIsPlaceholder ? 'Menunggu hasil pertandingan sebelumnya' : $rightRaw);
                    @endphp
                    <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="flex flex-col gap-2">
                            ...
                            @unless($matchReady)
                                <span class="inline-flex rounded-full bg-amber-500/10 px-3 py-1 text-[11px] font-semibold text-amber-200">Menunggu hasil pertandingan sebelumnya</span>
                            @endunless
                        </div>
                    </div>
